       ...
       <div class="cover-preview">
          <h4>Size</h4>
            <div class="demo-images"> 
                <div class="demo-img" :class="{'selected-type' : coverToEdit.type === 'header'}" :style="coverPreviewStyle" @click="setCoverType('header')">
                    <img  src="../../images/demo-cover3.png" alt="">
                </div>
                <div class="demo-img" :class="{'selected-type' : coverToEdit.type === 'inline'}" :style="coverPreviewStyle" @click="setCoverType('inline')">
